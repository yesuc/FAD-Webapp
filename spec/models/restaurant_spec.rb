...
RSpec.describe Restaurant, type: :model do
  it "should be able to create a Restaurant object which has the correct methods on it" do
    r = Restaurant.create!(name: "Hamilton Royal India Grill", url: "http://hamiltonroyalindiagrill.com/", address: "6 Broad Street Hamilton, NY 13346" , cuisine: "Indian", latitude: "42.8270", longitude: "75.5446")
    ...
    expect(r).to respond_to(:latitude)
    expect(r).to respond_to(:longitude)
  ...
  it "should fail to create a Restaurant object if no name is specified" do
    expect{Restaurant.create!(url: "http://hamiltonroyalindiagrill.com/", address: "6 Broad Street Hamilton, NY 13346" , cuisine: "Indian",latitude: "42.8270", longitude: "75.5446")}.to raise_exception(ActiveRecord::NotNullViolation)
    expect{Restaurant.create!(address: "6 Broad Street Hamilton, NY 13346" , cuisine: "Indian",latitude: "42.8270", longitude: "75.5446")}.to raise_exception(ActiveRecord::NotNullViolation)
  end

  it "should fail to create a Restaurant object if an address or latitude and longitude are not specified" do
    expect{Restaurant.create!(name: "Hamilton Royal India Grill", url: "http://hamiltonroyalindiagrill.com/", cuisine: "Indian")}.to raise_exception(ActiveRecord::NotNullViolation)
    expect{Restaurant.create!(name: "Hamilton Royal India Grill", url: "http://hamiltonroyalindiagrill.com/", cuisine: "Indian", latitude:"42.8270")}.to raise_exception(ActiveRecord::NotNullViolation)
    expect{Restaurant.create!(name: "Hamilton Royal India Grill", url: "http://hamiltonroyalindiagrill.com/", cuisine: "Indian", longitude:"75.5446")}.to raise_exception(ActiveRecord::NotNullViolation)
  end
  ...
  describe "filter_on_constraints test" do
    ...
    before(:example) do
      Restaurant.create!(name: "Hamilton Royal India Grill", url: "http://hamiltonroyalindiagrill.com/", address: "6 Broad Street Hamilton, NY 13346" , cuisine: "Indian",latitude: "42.8270", longitude: "75.5446")
      Restaurant.create!(name: "Another Indian Restaurant", address: "Hamilton, NY", cuisine: "Indian",latitude: "42.8270", longitude: "75.5446")
      Restaurant.create!(name: "La Iguana", url: "http://www.laiguanarestaurant.com/", address: "10 Broad St, Hamilton, NY 13346" , cuisine: "Mexican",latitude: "42.8270", longitude: "75.5446")
      Restaurant.create!(name: "N13", url: "http://www.noodles13.com/", address: "3 Lebanon St, Hamilton, NY 13346" , cuisine: "Asian",latitude: "42.8270", longitude: "75.5446")
    end
  ...
  describe "query_on_constraints test" do
    before(:example) do
      rig = Restaurant.create!(name: "Hamilton Royal India Grill", url: "http://hamiltonroyalindiagrill.com/", address: "6 Broad Street Hamilton, NY 13346" , cuisine: "Indian",latitude: "42.8270", longitude: "75.5446")
      ...
      mex = Restaurant.create!(name: "La Iguana", url: "http://www.laiguanarestaurant.com/", address: "10 Broad St, Hamilton, NY 13346" , cuisine: "Mexican",latitude: "42.8270", longitude: "75.5446")
      ...
      noodles = Restaurant.create!(name: "N13", url: "http://www.noodles13.com/", address: "3 Lebanon St, Hamilton, NY 13346" , cuisine: "Asian",latitude: "42.8270", longitude: "75.5446")
      ...
      taj = Restaurant.create!(name: "Another Indian Restaurant", address: "Hamilton, NY", cuisine: "Indian",latitude: "42.8270", longitude: "75.5446")
